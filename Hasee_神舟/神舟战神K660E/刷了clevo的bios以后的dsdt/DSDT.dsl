 ...
 * AML Disassembler version 20140828-64 [Sep 13 2014]
 * Copyright (c) 2000 - 2014 Intel Corporation
 * 
 * Disassembly of DSDT.aml, Sun Sep 14 15:22:25 2014
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000D058 (53336)
 *     Revision         0x02
 *     Checksum         0xC7
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
 ...
 */
DefinitionBlock ("DSDT.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000025)
{
    /*
    ...
    External (_PR_.PEG0.PEGP.TGPC, BuffObj)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xC59C4C18, 0x02AE)
    ...
    OperationRegion (SANV, SystemMemory, 0xC59B3E18, 0x016D)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xC580BE18, 0x10)
                                                ...
                                                If (LEqual (_T_2, 0x67))
                                                {
                                                    ...
                                                    If (^^PCI0.LPCB.EC.ECOK)
                                                    {
                                                        ...
                                                        Else
                                                        {
                                                            ...
                                                            Store (CA2R, BK2R)
                                                            Store (CA2B, BK2B)
                                                            Store (DerefOf (Index (XXX0, Zero)), ^^PCI0.LPCB.EC.FDAT)
                                                            Store (DerefOf (Index (XXX0, One)), ^^PCI0.LPCB.EC.FBUF)
                                                            Store (0xC2, ^^PCI0.LPCB.EC.FCMD)
                                                            Store (DerefOf (Index (XXX1, Zero)), ^^PCI0.LPCB.EC.FDAT)
                                                            Store (DerefOf (Index (XXX1, One)), ^^PCI0.LPCB.EC.FBUF)
...
Field (IGD2, AnyAcc, NoLock, Preserve)
{
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            Store (0xA9, \_SB.PCI0.LPCB.EC.DEBG)
            Store ("<<< GC6I >>>", Debug)
            \_SB.PCI0.LPCB.EC.ECNV (Zero)
            Store (One, \_SB.PCI0.PEG0.LNKD)
            Store (0xAA, \_SB.PCI0.LPCB.EC.DEBG)
        }

        Method (GC6O, 0, Serialized)
        {
            Store (0xAB, \_SB.PCI0.LPCB.EC.DEBG)
            Store ("<<< GC6O >>>", Debug)
            ...
            Store (0xAC, \_SB.PCI0.LPCB.EC.DEBG)
            \_SB.PCI0.LPCB.EC.ECNV (One)
            Store (0x55, \_SB.PCI0.LPCB.EC.DEBG)
        }
